...
/*
 * pr_debug — verbose diagnostic output, only compiled in when building
 * with DEBUG (make DEBUG=1). Use this for per-attempt/per-page noise
 * that should never appear in a release run.
 */
#ifdef DEBUG
